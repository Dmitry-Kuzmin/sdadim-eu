 ...
 * Mirrors src/lib/blog-posts.ts — update both when adding a new article.
 */
...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    excerpt: "Все термины, команды и знаки DGT на русском языке — с объяснениями и примерами для подготовки к экзамену.",
